...
import (
	...
	grpcserver "github.com/SemRels/updater-cargo/internal/grpc"
	semrelplugin "github.com/SemRels/updater-cargo/internal/plugin"
)

func main() {
	provider := semrelplugin.NewCargoUpdater("")
