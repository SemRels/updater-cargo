...
# SPDX-FileCopyrightText: 2026 The updater-cargo Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-updater-cargo" \
      org.opencontainers.image.description="semrel plugin: updater-cargo" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/updater-cargo" \
